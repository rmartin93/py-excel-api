...
const messages = [
	{
		...
		name: "John Smith",
		content:
			"Hi, I need to request a deviation for my upcoming business trip to Chicago. My flight was changed by the airline.",
		timestamp: "10:23 AM",
	},
	{
		id: 2,
		...
		name: "Travel Admin",
		content:
			"Hello John! I'd be happy to help with your deviation request. Could you please provide your original booking reference and the new flight details?",
		timestamp: "10:25 AM",
	},
	{
		id: 3,
		...
		name: "John Smith",
		content:
			"Original booking: AA2847, departing March 15 at 2:30 PM. New flight: AA2901, departing March 15 at 6:45 PM.",
		timestamp: "10:27 AM",
	},
	{
		id: 4,
		...
		name: "Travel Admin",
		content:
			"Thank you for that information. I've reviewed your case and the airline-initiated change is within policy. I'll approve this deviation right away.",
		timestamp: "10:30 AM",
	},
	{
		id: 5,
		sender: "user",
		name: "John Smith",
		content: "Perfect, thank you so much for the quick response!",
		timestamp: "10:31 AM",
	},
];

export function TravelChatCard() {
	return (
		<Card className="w-full max-w-2xl">
			<CardHeader>
				<CardTitle>Travel Deviation Case #TD-2024-0342</CardTitle>
				<CardDescription>Flight change request - Chicago business trip</CardDescription>
			</CardHeader>
			<CardContent>
